...
<html lang="en">
  ...
  <base href="<?php echo base_url();?>" />
    ...
    <title>Telework Portfolio Dashboard</title>
    ...
    <link href="resource/dist/css/dashboard_object.css" rel="stylesheet">
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          ...
          <ul class="nav nav-sidebar">
            ...
            <li><a href="">Hoteling</a></li>
            <li><a href="">Inventory</a></li>
          </ul>
        </div>
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header" id="mName">Testing</h1>

          <div class="row placeholders">
            <div class="col-xs-6 col-sm-3 placeholder">
              <div class="circle_small">Dashboard</div>
			  <!--<img data-src="holder.js/200x200/auto/sky" class="img-responsive" alt="Generic placeholder thumbnail">-->
              <h4>Label</h4>
              <span class="text-muted">Something else</span>
            </div>
            <div class="col-xs-6 col-sm-3 placeholder">
			<div class="circle_small">Testing</div>
