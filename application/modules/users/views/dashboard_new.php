 ...
 <div class="table-responsive">
            <table class="table table-striped">
 			...
 			<?php foreach($timesheet1 as $timesheet): ?>
                <tr>
                  <td><?php echo $timesheet->date1?></td>
                  <td><?php echo $timesheet->date2?></td>
                  <td><?php echo $timesheet->location?></td>
                  <td><?php $startime = new DateTime($timesheet->clock_in); echo $startime->format('h:i:s'); ?></td>
                  <td><?php if (isset($timesheet->clock_out)){$endime = new DateTime($timesheet->clock_out); echo $endime->format('h:i:s');} ?></td>
