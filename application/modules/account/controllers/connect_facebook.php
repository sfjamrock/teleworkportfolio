				...
				if ( ! $this->authentication->is_signed_in())
				{
					...
					$this->session->set_userdata('connect_create', array(
						...
						array(
							...
							'picture' => 'http://graph.facebook.com/'.$this->facebook_lib->user['id'].'/picture/?type=normal'
...
<head>        <link rel="shortcut icon" href="resource/resource/images/favicon.ico" /></head>
		  <body>
