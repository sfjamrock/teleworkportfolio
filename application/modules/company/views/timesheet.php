  ...
  <body>
    <?php echo $this->load->view('header_new'); ?> 
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">EMPLOYEE HOURS</h1>
			 <div class="shadetabs">
                <ul id="countrytabs">
                    <li><a href="#" rel="country1" class="selected">LOCATIONS</a></li>
                    <li><a href="#" rel="country2">EMPLOYEES</a></li>
                    <li><a href="#" rel="country3">EDIT TIMESHEETS</a></li>
                </ul>
             </div>
             <div class="tab_content">

                <div id="country1" class="tabcontent"><?php echo $this->load->view('timesheet_location'); ?></div>
                <div id="country2" class="tabcontent"><?php echo $this->load->view('timesheet_employee'); ?></div>
                <div id="country3" class="tabcontent"><?php echo $this->load->view('timesheet_edit'); ?></div>
