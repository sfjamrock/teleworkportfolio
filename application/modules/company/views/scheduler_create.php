                    ...
                    <div class="datewise_details">
                        ...
                        <div class="table_row">
                        	...
                        	<div class="username"><?php echo $row2->firstname?> <?php echo $row2->lastname?> <?php echo $user_id ?></div>
								

                            <div class="text_holder">
                            	<div class="start_time"><input type="time" name="<?php echo $row2->firstname, $row2->lastname?>"></div>
