...
<meta name="description" content="The telework ROI system for companies and employees to evaluate the effectiveness of their telework program" />
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="item active">
          <img src="resource/images/banner-bg.jpg" alt="&nbsp;">
          <div class="container">
...
<h2>About Us</h2>
Do you want to work from home more? Telework Portfolio gives you the tool you need to find out if telework is right for you. 
...
About Telework Portfolio Founder Sean Fuller
...
If you would like more information about any of the services that Telework Portfolio offer, please contact us by using any of the following methods:Contact Info Area:
Full Name:Sean FullerEmail:sfuller@teleworkportfolio.com  </div>
