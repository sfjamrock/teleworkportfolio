...
<ol type="A">
<li >You must not use our sites, including its services and or tools if you are not able to form legally binding contracts, are under the age of 18, or are temporarily or indefinitely suspended from using our sites, services, or tools</li>

<li >You should not post any blogs, items, messages, and or contents that are inappropriate and fails to observe sense of decency and or would offend other persons;</li>

<li > You must not republish, sell, rent or sub-license any materials from this website including republication on another website;</li>

<li > You must not collect and disclose information about users’ personal information;</li>
<li > you must not reproduce, duplicate, copy or otherwise exploit material on our website for a commercial purpose</li>
<li > you must not post false, inaccurate, misleading, defamatory, or libelous content;</li>
<li > you must not take any action that may damage the rating system.</li>
...
<br/>
<h3>WARRANTY DISCLAIMER AND EXCLUSIONS / LIMITATIONS OF LIABILITY</h3>

You represent and warrant that (a) all of the information provided by you to our website to participate in the Service is correct and current; and (b) you have all necessary right, power and authority to enter into this Agreement and to perform the acts required of you hereunder.<br/><br/>
...
You agree not to disclose information you obtain from us and or from our clients, advertisers, suppliers and forum members. All information submitted to by an end-user customer pursuant to a Program is proprietary information of Telework Portfolio.com. Such customer information is confidential and may not be disclosed. Publisher agrees not to reproduce, disseminate, sell, distribute or commercially exploit any such proprietary information in any manner.


<br/>
<h3>NON-ASSIGNMENT OF RIGHTS</h3>

Your rights of whatever nature cannot be assigned nor transferred to anybody, and any such attempt may result in termination of this Agreement, without liability to us. However, we may assign this Agreement to any person at any time without notice.

 
<h4>Waiver and Severability of Terms.</h4>
Failure of the Telework Portfolio.com to insist upon strict performance of any of the terms, conditions and covenants hereof shall not be deemed a relinquishment or waiver of any rights or remedy that the we may have, nor shall it be construed as a waiver of any subsequent breach of the terms, conditions or covenants hereof, which terms, conditions and covenants shall continue to be in full force and effect.
No waiver by either party of any breach of any provision hereof shall be deemed a waiver of any subsequent or prior breach of the same or any other provision.<br/><br/>
...
<h4>Choice of Law; Jurisdiction; Forum</h4>
